...
if Devmfm:get(mustafa.."mfm:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_mfm(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
Devmfm:setex(mustafa..'mfm:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
