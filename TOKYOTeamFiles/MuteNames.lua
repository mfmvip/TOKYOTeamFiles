...
if DevAbs:get(David.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(David.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
if not Manager(msg) and DevAbs:get(David.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
DavidName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if DavidName then 
DavidNames = DevAbs:smembers(David.."Abs:Mute:Names"..msg.chat_id_) or ""
...
DevAbs:set(David.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(David.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
